...
NEXT TASK: T2.41 — the editors for what a key holds: string, hash, list, set
           and sorted set. The connection (T2.39) and the key browser (T2.40)
           are done; 2.D and 2.E are done.
...
LAST DONE: 2026-09-13 — the Redis key browser, a database's keys in the grid
           (T2.40, ADR-0073). 2026-09-12 — the Redis connection, three
