...
NEXT TASK: T2.21 (writing the rows: insert, upsert, replace, append to
           a new table), then T2.22 (batch size and error policy). What is
           open in Phase 1
...
LAST DONE: 2026-09-11 — a dry run over a whole file to import, listing
           each value that would not go in (T2.20, ADR-0048). Before it: a
