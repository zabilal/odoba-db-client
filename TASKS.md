...
NEXT TASK: T2.52 — the consistency-level selector: a read's consistency is
           a person's choice (ONE, QUORUM, LOCAL_QUORUM…), and gocql takes
           it per query. Then T2.53, conformance green for Cassandra, which
           is what is left of 2.G.
