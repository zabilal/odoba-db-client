...
NEXT TASK: T2.15 (a foreign key's label shown inline), then T2.16 (master
           and detail). What is open in Phase 1
...
LAST DONE: 2026-09-11 — the rows that refer to a row shown (T2.14,
           ADR-0041). Before it: a foreign key followed to the row it refers
