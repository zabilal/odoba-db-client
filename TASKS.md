...
NEXT TASK: T2.8 (row identity: SQLite's browse returning its rowid, and
           a key nominated for rows with none, FR-4.7), then T2.9. What is
...
LAST DONE: 2026-09-11 — changes reverted by cell, row or all, and
           asked about before a tab closes or the app quits (T2.7,
           ADR-0033). Before it: changes reviewed and committed (T2.5,
