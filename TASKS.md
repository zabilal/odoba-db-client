...
NEXT TASK: T2.16 (master and detail: a row's child rows in a nested
           grid), then T2.17 (import readers). What is open in Phase 1
...
LAST DONE: 2026-09-11 — a foreign key's value shown with its row's label
           (T2.15, ADR-0042). Before it: the rows that refer to a row shown
