...
NEXT TASK: T2.10 (a pasted block), then T2.11. What is open in Phase 1
...
LAST DONE: 2026-09-11 — a query's result edited in its grid, committed
           to its table and read again (T2.9, ADR-0036), once its columns
           say where they come from (ADR-0035). Before it: row identity (T2.8, ADR-0034), changes reverted, and asked about before
