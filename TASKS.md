...
LAST DONE: 2026-09-10 — the filter row, applied on the server (T1.55, ADR-0016).
```
...
- [~] **T1.54** Per-column filters with distinct-value picklist and operators → FR-3.4 — *every operator is reachable from the filter row (T1.55); the distinct-value picklist is open: no driver implements DistinctLister yet*
