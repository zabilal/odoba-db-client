...
| The binary is 81.0 MB against a 60 MB budget | performance | Measured on every build; the decision is the owner's (T4.30). Two drivers are most of it — Oracle 14.8 MB, Kafka 10.4 MB. Nothing is lost. |
