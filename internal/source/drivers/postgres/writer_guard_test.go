...
func TestEveryWritePathIsGuarded(t *testing.T) {
	...
	ro := &pgSource{cfg: source.ConnectionConfig{Guard: source.Guard{ReadOnly: true}}}
	prod := &pgSource{cfg: source.ConnectionConfig{Guard: source.Guard{Environment: source.EnvProduction}}}

	guardcheck.Check(t, ro, prod, map[string]func(*pgSource, bool) error{
		"Apply": func(s *pgSource, c bool) error {
		...
		"LoadRows": func(s *pgSource, c bool) error {
