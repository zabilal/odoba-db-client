...
CREATE TABLE ikigai_it.writes (id int GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name varchar(40) NOT NULL DEFAULT 'none', n int);
...
func TestConformance(t *testing.T) {
	...
	conformance.Run(t, conformance.Target{
		...
		Browsable: ordersRef,
		Writable:  model.NewRef(model.KindTable, env("IKIGAI_PG_DB", "ikigai_test"), "ikigai_it", "writes"),
		OpenGuarded: func(ctx context.Context, t *testing.T, g source.Guard) source.Source {
			cfg := testConfig(g.ReadOnly)
			cfg.Guard = g
